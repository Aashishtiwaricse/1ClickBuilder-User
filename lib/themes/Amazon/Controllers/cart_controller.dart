...
import 'package:one_click_builder/themes/Amazon/api/Sigin/guestsigin.dart';
import 'package:one_click_builder/themes/Amazon/api/cart/AmzCart.dart';
...
class AmzCartController extends GetxController {
...
Future<void> removeItem({
  ...
  try {
    ...
    final url =
        '${AmzAppConstant.baseUrl}/api/cart/remove-item/$VendorId';
